...
class FavoritesControllerTest < ActionController::TestCase
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post :create, favorite: { district_id: @favorite.district_id, name: @favorite.name, user_id: @favorite.user_id }
    end
  ...
  test "should update favorite" do
    patch :update, id: @favorite, favorite: { district_id: @favorite.district_id, name: @favorite.name, user_id: @favorite.user_id }
    assert_redirected_to favorite_path(assigns(:favorite))
  end
